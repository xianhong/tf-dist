...
def prepare(TASK_ID,BATCH_SIZE,NUM_WORKERS):
	...
	BUFFER_SIZE = 2000
	train_datasets_unbatched = train_dataset.shard(NUM_WORKERS,TASK_ID).repeat().shuffle(BUFFER_SIZE)
...
if __name__=='__main__':
	...
	train_datasets = prepare(TASK_ID=args.task,BATCH_SIZE = args.batch,NUM_WORKERS = args.workers)
